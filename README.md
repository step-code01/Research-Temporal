...
> **Note**: This is an ongoing study (and part of greater research) into how VideoLLMs represent time mechanistically not just whether they get the right answer, but why.
...
### II. Phase 1: Proving the Problem Exists
...
> What are different architectures *actually attending to* when they classify motion?
